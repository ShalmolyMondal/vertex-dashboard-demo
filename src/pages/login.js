...
export default function Login() {
  return (
    ...
    <div className='h-screen bg-slate-500 rounded-2xl'>
        <img 
    ...
    alt="Logo" className="w-16 h-16 mb-4" />
        ...
        {/* card details */}
        <form className='max-w-[400px] w-full mx-auto bg-slate-50 p-7 rounded-md relative z-10'> 
           ...
           <div className='mt-6 flex flex-col gap-y-4'>
                <button className='bg-orange-100 text-white py-2 text-md font-bold rounded-md active:scale-[.95] active:duration-75 transition-all hover:scale-[1.05] ease-in-out'> 
                    Sign In </button>
            ...
            <div className='mt-6 flex items-center justify-between'>
                ...
                <div>
                    <button className='font-medium text-base text-amber-500'>                        
                        Forgot Password 
                    </button>        
                </div>
            </div>  
           ...
           <div className='mt-8 flex justify-center items-center'>
                ...
                <button className='text-orange-200 text-base font-medium p-2'> Sign up now </button> 
           </div>    
