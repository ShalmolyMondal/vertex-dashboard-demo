...
// import loginImg from '../assets/image-vertex1.jpg'
...
export default function Login() {
  return (
    ...
    <div className='relative w-full h-screen bg-blue-900/90 rounded-3xl'>
        {/* <img className='absolute w-full h-full object-cover mix-blend-overlay' src={loginImg} alt="/" /> */}
    
    {/* <p className='font-small'> IoT Cloud Platform </p> */}
    <div className='flex justify-center items-center h-full'>
        {/* card details */}
        <form className='max-w-[400px] w-full mx-auto bg-white p-7 rounded-md'> 
            ...
            <div className='relative flex flex-col'>
                ...
                <AiFillUnlock size="55" className='absolute ml-3' color='grey'/>
                <input className='border relative bg-gray-100 p-2 rounded-md' 
           ...
           <div className='mt-6 flex flex-col gap-y-4'>
                <button className='bg-orange-400 text-white py-2 text-md font-bold rounded-md active:scale-[.95] active:duration-75 transition-all hover:scale-[1.05] ease-in-out'> Sign In </button>
            ...
            <div className='mt-6 flex items-center justify-between'>
                ...
                <div>
                    <button className='font-medium text-base text-orange-300'>                        
                        Forgot Password 
                    </button>        
                </div>
            </div>  
           ...
           <div className='mt-8 flex justify-center items-center'>
                ...
                <button className='text-orange-400 text-base font-medium p-2'> Sign up now </button> 
           </div>
